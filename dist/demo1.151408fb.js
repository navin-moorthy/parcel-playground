...
exports.lerp = exports.getMousePosition = void 0;
...
window.addEventListener("mousemove", function (event) {
  mouse = (0, _utils.getMousePosition)(event);
});
...
var Cursor = /*#__PURE__*/function () {
  function Cursor(element) {
    ...
    this.onMouseMoveEvent = function () {
      ...
      _gsap.default.to(_this.DOM.element, {
        duration: 0.9,
        ease: "Power3.easeOut",
        opacity: 1
      });
      ...
      window.removeEventListener("mousemove", _this.onMouseMoveEvent);
    };
  ...
  _createClass(Cursor, [{
    ...
    value: function render() {
      ...
      this.DOM.element.style.transform = "translateX(".concat(this.renderedStyles["tx"].previous, "px) translateY(").concat(this.renderedStyles["ty"].previous, "px) scale(").concat(this.renderedStyles["scale"].previous, ")");
...
Promise.all([(0, _utils.preloadFonts)("ldj8uhs")]).then(function () {
  // Remove loader (loading class)
  document.body.classList.remove("loading");
  var cursor = new _cursor.Cursor(document.querySelector(".cursor"));
  console.log("%c cursor", "color: #00bf00", cursor);
});
},{"../cursor":"js/cursor.js","../utils":"js/utils.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
